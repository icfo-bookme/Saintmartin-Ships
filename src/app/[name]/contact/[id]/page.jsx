...
export const metadata = {
  title: "Contact Us | {ship.title}",
  description: "Get in touch with {ship.title}. Find our office location, phone numbers, email address, and follow us on social media.",
};
      ...
      <section className="bg-white min-h-screen py-10 ">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center px-6 text-gray-500 mb-10">
            Reach out to {ship.title} – we are here to help you with inquiries, bookings, and support.
          </p>
